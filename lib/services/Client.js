...
ClientService.prototype.list = function (callback) {
  //cb(err, clients, metaData)
...
ClientService.prototype.create = function (client, cb) {
  //cb(err, client)
...
ClientService.prototype.update = function (client, cb) {
  //cb(err, clients)
...
ClientService.prototype.get = function (id, cb) {
  //cb(err, client)
...
ClientService.prototype.delete = function (id, cb) {
  //cb(err)
