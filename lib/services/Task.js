...
TaskService.prototype.list = function (cb) {
  //cb(err, task, metaData)
...
TaskService.prototype.create = function (task, cb) {
  //cb(err, task)
...
TaskService.prototype.update = function (task, cb) {
  //cb(err, task)
...
TaskService.prototype.get = function (id, cb) {
  //cb(err, task)
...
TaskService.prototype.delete = function (id, cb) {
  //cb(err)
